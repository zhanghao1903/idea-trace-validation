...
- 让 REQ-001 至 REQ-027、AC-001 至 AC-019 和 Slice 0–9 均有明确 LP 主归属。
...
`REQ-028` 与 `AC-020` 由本规划 feature 承接，不形成第六份运行时计划。
AC-001 至 AC-019 按照其主要可观察结果映射到一个 LP；跨计划验收标准可在次要引用
中说明，但管理入口只记录唯一主归属。
...
- 人工核对五份计划的十个必需章节；
- 人工核对依赖链和状态均为初始值；
- 人工核对 REQ-001 至 REQ-027、AC-001 至 AC-019、Slice 0–9 的 LP 主归属，
  并确认 REQ-028/AC-020 指向本规划 feature；
