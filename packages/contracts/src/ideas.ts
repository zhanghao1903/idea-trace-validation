...
export const AuditSummarySchema = Type.Object(
  {
    ...
    relatedAuthorityId: Type.Optional(Type.String()),
  },
  strict,
);
...
export const AuditEventDtoSchema = Type.Object(
  {
    ...
    eventType: Type.Union([
      ...
      Type.Literal("PROJECT_TRANSITIONED"),
      Type.Literal("PROJECT_PROGRESS_RECORDED"),
      Type.Literal("ATTENTION_ITEM_CREATED"),
      Type.Literal("ATTENTION_ITEM_UPDATED"),
      Type.Literal("ATTENTION_RESPONSE_CORRECTED"),
      Type.Literal("EVIDENCE_RECORDED"),
      Type.Literal("EVIDENCE_CORRECTED"),
      Type.Literal("EVIDENCE_RETRACTED"),
      Type.Literal("CONCLUSION_RECORDED"),
      Type.Literal("CONFIRMATION_REQUESTED"),
      Type.Literal("CONFIRMATION_REJECTED"),
      Type.Literal("CONCLUSION_CONFIRMED"),
      Type.Literal("PROJECT_COMPLETED"),
      Type.Literal("PROJECT_STOPPED"),
      Type.Literal("PROJECT_TRANSFERRED"),
      Type.Literal("PROJECT_REOPENED"),
    ]),
